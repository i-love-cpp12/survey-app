...
import { setCopyBtnEventListener, getSurveyInfo } from "../shared/vote_module.js";
//add refresh, add code reading from url params 
function render(surveyData, refreshRateMS = 200) {
    ...
    $("section .updates span").innerText = String(refreshRateMS / 100);
